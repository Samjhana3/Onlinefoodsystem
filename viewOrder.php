        ...
        <div class="table-wrapper" id="empty">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-8">						
                        <?php //<a href="" class="btn btn-primary"><i class="material-icons">&#xE863;</i> <span>Refresh List</span></a>?>
                       <?php // <a href="#" onclick="window.print()" class="btn btn-info"><i class="material-icons">&#xE24D;</i> <span>Print</span></a> ?>
                        <?php // <i class="material-icons"></i> ?>
                    </div>
                </div>
            </div>
